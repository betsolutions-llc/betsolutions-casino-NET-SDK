...
using Betsolutions.Casino.SDK.Internal.TableGames.Domino.DTO.Achievement;
using RestSharp;

namespace Betsolutions.Casino.SDK.Internal.TableGames.Domino.Repositories
{
    internal class DominoAchievementRepository : BaseRepository
    {
        internal DominoAchievementRepository(MerchantAuthInfo authInfo) : base(authInfo, "DominoAchievement")
        {
