...
using Betsolutions.Casino.SDK.Internal.TableGames.Seka.DTO.Tournament;
using RestSharp;

namespace Betsolutions.Casino.SDK.Internal.TableGames.Seka.Repositories
{
    internal class SekaTournamentRepository : BaseRepository
    {
        internal SekaTournamentRepository(MerchantAuthInfo authInfo) : base(authInfo, "SekaTournament")
        {
