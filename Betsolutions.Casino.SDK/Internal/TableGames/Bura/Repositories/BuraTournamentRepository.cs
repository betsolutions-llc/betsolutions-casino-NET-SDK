...
using Betsolutions.Casino.SDK.Internal.TableGames.Bura.DTO.Tournament;
using RestSharp;

namespace Betsolutions.Casino.SDK.Internal.TableGames.Bura.Repositories
{
    internal class BuraTournamentRepository : BaseRepository
    {
        internal BuraTournamentRepository(MerchantAuthInfo authInfo) : base(authInfo, "BuraTournament")
        {
