...
using Betsolutions.Casino.SDK.Internal.TableGames.Okey.DTO.Tournament;
using RestSharp;

namespace Betsolutions.Casino.SDK.Internal.TableGames.Okey.Repositories
{
    internal class OkeyTournamentRepository : BaseRepository
    {
        internal OkeyTournamentRepository(MerchantAuthInfo authInfo) : base(authInfo, "OkeyTournament")
        {
